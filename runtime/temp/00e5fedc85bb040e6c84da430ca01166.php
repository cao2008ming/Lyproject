<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:31:"./themes/admin/pages\index.html";i:1499446552;s:24:"./themes/admin/base.html";i:1499446551;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<div class="layui-body">
    ...
    <div class="layui-tab layui-tab-brief">
        <ul class="layui-tab-title">
            ...
            <li class=""><a href="<?php echo url('admin/pages/add'); ?>">添加单页</a></li>
        </ul>
            ...
            <div class="layui-tab-item layui-show">
                <table class="layui-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo url('admin/pages/edit',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-normal layui-btn-mini">编辑</a>
                            <a href="<?php echo url('admin/pages/delete',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-danger layui-btn-mini ajax-delete">删除</a>
                        </td>
                    </tr>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                    </tbody>
