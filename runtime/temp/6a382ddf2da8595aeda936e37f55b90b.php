<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:30:"./themes/admin/cate\index.html";i:1499446551;s:24:"./themes/admin/base.html";i:1499446551;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
            ...
            <div class="layui-tab-item layui-show">
                <table class="layui-table">
                    ...
                    <tr>
                        ...
                        <td><?php echo get_model_name($vo['model_id']); ?></td>
                        <td><?php echo $vo['status']==1 ? '启用' : '禁用'; ?></td>
                        <td>
                            <a href="<?php echo url('admin/cate/edit',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-normal layui-btn-mini">编辑</a>
                            <a href="<?php echo url('admin/cate/delete',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-danger layui-btn-mini ajax-delete">删除</a>
                        </td>
                    </tr>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                    </tbody>
