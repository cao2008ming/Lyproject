<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:31:"./themes/admin/login\index.html";i:1499446551;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN" style="background: linear-gradient(0deg, #0b4182 1%, #1e88e5 100%);height: 100%;">
<head>
    <meta charset="utf-8">
...
<body class="login">
<div class="login-title">驴友天下后台管理系统</div>
...
<p class="copyright">&copy; 2017 Powered By <a href="http://www.juzhonghui.cn">贵州聚众汇科技有限公司</a> </p>
<script>
    // 定义全局JS变量
    var GV = {
